...
$(function () {
  var btn_menu = $('.header-menu-btn--menu');
  var body = $('body');
...
var _owlinit = __webpack_require__(5);
...
$(window).on('load', function () {
  (0, _owlinit2.default)($('.services-list'), {
    items: 1,
    nav: true,
